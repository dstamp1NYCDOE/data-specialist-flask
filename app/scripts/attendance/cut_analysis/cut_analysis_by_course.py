...
def main():
    ...
    pvt_by_course = pd.pivot_table(attendance_marks_df, index=['Pd','Course','Section','Teacher'], columns='potential_cut',values='StudentID',aggfunc='count')
    pvt_by_course = pvt_by_course.reset_index()
    sheets.append(("total", pvt_by_course))
    ...
    download_name = "cut_report_by_course.xlsx"
