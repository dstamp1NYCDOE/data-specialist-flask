...
def create_courses(teacher_row,period):
    ...
    if course_code in ['GAS85', 'GAS87']:
        for day, cycle_day in [("A", "'01000"), ("B", "'00100"), ("C", "'00010"), ("D", "'00001")]:
    ...
    if course_code in ['GAS81', 'GAS82']:
        ...
        for day,cycle_day in [("A","'01010"),("B","'00101")]:
            ...
            output.append(return_mapped_lunch_for_yl(
                teacher_row, period, day, cycle_day))
            teacher_row[f"Period{period}"] = 'GLS11QYL'+offset_string
            output.append(create_master_course(
                teacher_row, period, day, "'10000"))
...
def return_section_number(teacher_row,period,cycle=None):
    ...
    return (TeacherID+offset)*10 + {"A":1,"B":3,"C":5,"D":7,"E":9}.get(cycle,0) - period
