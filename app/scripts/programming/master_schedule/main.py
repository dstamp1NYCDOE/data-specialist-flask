...
import app.scripts.programming.master_schedule.process_academic_dept as process_academic_dept
...
def main():
    ...
    for academic_dept in ['Spanish','Math','Science','SS','ELA']:
        output_list.extend(process_academic_dept.main(academic_dept))
