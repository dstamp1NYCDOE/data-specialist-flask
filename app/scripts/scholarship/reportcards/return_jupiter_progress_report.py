...
def main():
    ...
    students_df = return_students_df().sort_values(
...
def return_student_grades():
    ...
    jupiter_rosters_df = jupiter_rosters_df.merge(
        code_deck_df[["Course", "CourseName", "Credits"]],
        on="Course",
        how="left",
    )
    jupiter_rosters_df = jupiter_rosters_df[jupiter_rosters_df["Course"].str[0] != "Z"]
    jupiter_rosters_df = jupiter_rosters_df[jupiter_rosters_df["Course"].str[1] != "X"]
    ...
    jupiter_rosters_df = jupiter_rosters_df[~jupiter_rosters_df["Course"].isin(courses_to_exclude)]
    jupiter_rosters_df = jupiter_rosters_df.drop_duplicates(subset=["StudentID", "Course"])

    print(jupiter_rosters_df)
    return jupiter_rosters_df
